...
public class InsertUser {
    ...
    public InsertUser(Connection c) {
        conn = c;
    }
    ...
    public void insertUser() throws SQLException{
        ...
        // Insert user record
        insertUser(userEmail, userName, phoneNumber);
        ...
        if (isCustomer.equalsIgnoreCase("y")) {
            ...
            insertCustomer(userEmail, address);
        }
        ...
        if (isDriver.equalsIgnoreCase("y")) {
            ...
            insertDriver(userEmail, rating, numTrips, joinDate, licensePlate, carType);
        }
    ...
    private void insertUser(String userEmail, String userName, String phoneNumber)
            throws SQLException {
    ...
    private void insertCustomer(String userEmail, String address) throws SQLException {
    ...
    private void insertDriver(String userEmail, float rating, int numTrips, Date joinDate,
